...
const int distanceArretCourse = 5;                    // Définition de la distance d'arret du robot à 5 cm
...
//Encodeurs
unsigned long positionEncodeurGauche = 0;
unsigned long positionEncodeurDroite = 0;
...
void setup(void) {
  ...
  attachInterrupt(digitalPinToInterrupt(bumperGauche), nomDeLaFonction, CHANGE); //RISING FALLING OU CHANGE ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
